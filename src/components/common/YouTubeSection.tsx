    ...
    <section className="py-24 bg-gray-50">
      <div className="container">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div>
            <h2 className="text-3xl font-black mb-2">Our YouTube Ecosystem</h2>
            <p className="text-gray-500">Free high-quality lectures and strategy videos for every board and exam.</p>
          </div>
          <button className="px-8 py-3 bg-red-600 text-white rounded-full font-bold hover:bg-red-700 transition-colors flex items-center gap-2 w-fit">
