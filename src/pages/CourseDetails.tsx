...
export const CourseDetails: React.FC = () => {
  ...
  return (
    <div className="bg-white min-h-screen pb-14">
      ...
      <div className="bg-gray-50 border-b border-gray-100 pt-3">
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12">
            ...
            <div className="space-y-8">
              {course.details && (
                <>
                  <div className="bg-orange-50/50 p-6 rounded-[2.5rem] border border-orange-100">
                  ...
                  <div className="bg-gray-900 text-white p-6 rounded-[2.5rem] relative overflow-hidden">
                    <div className="relative z-10">
                      <h3 className="text-xl font-black mb-2 flex items-center gap-3 text-blue-400">
                        <CalendarDays />
                        Course Validity
                      </h3>
                      <p className="text-2xl font-bold mb-4">{course.details.validity}</p>
